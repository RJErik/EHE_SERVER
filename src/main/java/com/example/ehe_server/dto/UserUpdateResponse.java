...
public class UserUpdateResponse {
    ...
    public UserUpdateResponse(Integer id, String userName, String email, String accountStatus, String registrationDate) {
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        UserUpdateResponse that = (UserUpdateResponse) o;
