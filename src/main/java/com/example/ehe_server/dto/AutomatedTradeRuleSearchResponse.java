...
public class AutomatedTradeRuleSearchResponse {
    private Integer id;
    ...
    public AutomatedTradeRuleSearchResponse() {}

    public AutomatedTradeRuleSearchResponse(Integer id, Integer portfolioId, String portfolioName, String platform, String symbol, String conditionType, String actionType, String quantityType, BigDecimal quantity, BigDecimal thresholdValue, String dateCreated, boolean isActive) {
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        AutomatedTradeRuleSearchResponse that = (AutomatedTradeRuleSearchResponse) o;
