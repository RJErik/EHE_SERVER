...
public class AutomatedTradeRuleCreationResponse {
    private Integer id;
    ...
    public AutomatedTradeRuleCreationResponse() {}

    public AutomatedTradeRuleCreationResponse(Integer id, Integer portfolioId, String portfolioName, String platform, String symbol, String conditionType, String actionType, String quantityType, BigDecimal quantity, BigDecimal thresholdValue, String dateCreated, boolean isActive) {
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        AutomatedTradeRuleCreationResponse that = (AutomatedTradeRuleCreationResponse) o;
