...
public class UserRetrievalResponse {
    ...
    public UserRetrievalResponse(Integer id, String userName, String email, String accountStatus, String registrationDate) {
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        UserRetrievalResponse that = (UserRetrievalResponse) o;
