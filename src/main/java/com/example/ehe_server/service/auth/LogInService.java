    ...
    public Map<String, Object> authenticateUser(LoginRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            if (user.getAccountStatus() == User.AccountStatus.NONVERIFIED) {
                ...
                loggingService.logAction("Login failed: Account is not verified.");
                return responseBody;
            }
            ...
            if (user.getAccountStatus() != User.AccountStatus.ACTIVE) {
                ...
                loggingService.logAction("Login failed: Account not active");
                return responseBody;
            }
            ...
            if (!BCrypt.checkpw(request.getPassword(), user.getPasswordHash())) {
                ...
                loggingService.logAction("Login failed: Invalid password");
                return responseBody;
            }
